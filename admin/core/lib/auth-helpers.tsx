...
export const getBaseAuthenticationModes: (props: TGetBaseAuthenticationModeProps) => TInstanceAuthenticationModes[] = ({
...
}) => [
  {
    ...
    name: "Unique codes",
    description:
      "Log in or sign up for Nexio using codes sent via email. You need to have set up SMTP to use this method.",
  ...
  },
  {
    key: "google",
    name: "Google",
    description: "Allow members to log in or sign up for Nexio with their Google accounts.",
  ...
  },
  {
    key: "github",
    name: "GitHub",
    description: "Allow members to log in or sign up for Nexio with their GitHub accounts.",
    icon: (
      <Image
